...
let item, question;
                    ...
                    try {
                        ...
                        if (errorIteration() < 4) {
                            ...
                            return console.log("%c Ocorreu um erro inesperado!", "color: red; font-weight: bolder; font-size: 20px;");
                        }
                    }
            ...
            if (!window.loaded) {
                console.clear();
                console.log("%c Khan Academy Bot ", "color: mediumvioletred; -webkit-text-stroke: .5px black; font-size:40px; font-weight:bolder; padding: .2rem;");
                console.log("%cDesenvolvido por icfranco", "color: blue; -webkit-text-stroke: .5px black; font-size:15px; font-weight:bold;");
                window.loaded = true;
            }
